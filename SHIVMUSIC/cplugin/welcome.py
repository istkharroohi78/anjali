...
def generate_welcome_image(pic_path, user_id, uname):
    bg_path = "SHIVMUSIC/assets/wel2.png"
    font_path = "SHIVMUSIC/assets/font.ttf"
    ...
    try:
        ...
        if os.path.exists("SHIVMUSIC/assets/upic.png"):
            pfp = Image.open("SHIVMUSIC/assets/upic.png").convert("RGBA") 
        else:
...
async def greet_new_member(client, member: ChatMemberUpdated):
    ...
    try:
        ...
        # Agar custom nahi hai to default Image Welcome
            ...
            pic_path = "SHIVMUSIC/assets/upic.png"
            if user.photo:
                try:
                    os.makedirs("downloads", exist_ok=True)
